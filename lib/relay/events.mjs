...
const TYPE_MAP = Object.freeze({
  ...
  'request.opened': 'permission.requested',
...
const CONTROL_TYPES = new Set([
  ...
  'approval.requested', 'permission.requested', 'human.input_required', 'human.replied',
  'approval.granted', 'approval.denied',
  'github.ci_failed', 'github.pr_updated', 'github.workflow_updated',
  'github.check_updated', 'github.event_received', 'capability.became_ready',
  'git.changed'
]);
